...
let DataService = class DataService {
    ...
    setCurrentRouteDataUsingUrl(dataToFetch) {
        ...
        this.httpService.doGetRequest("/", {
            ...
            const currentMetadata = feData[locale];
