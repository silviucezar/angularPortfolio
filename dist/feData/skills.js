    ...
    Javascript: {
        ...
        skill: {
            angularJS: {
                title: 'AngularJS',
                description: [
                    'Folosit la dezvoltarea unei aplicatii pentru un fost angajator.'
                ]
            },
            jQuery: {
                title: 'JQuery',
                description: [
                    'Folosit in principiu la mentenanta legacy code-ului.'
                ]
            }
        },
        knowledgeSummary: {
    ...
    NodeJS: {
        ...
        skill: {
            express: {
                title: 'ExpressJS',
                description: [
                    'Principalul framework folosit la dezvoltarea BackEnd-ului pentru proiectele personale si ale fostilor angajatori.',
                    'La momentul de fata il folosesc impreuna cu Typescript.'
                ]
            },
            electron: {
                title: 'ElectronJS',
                description: [
                    'Folosit la dezvoltarea unei aplicatii desktop cu tehnologii web pentru fosti angajatori.'
                ]
            },
            sequelize: {
                title: 'Sequelize',
                description: [
                    'L-am folosit pentru un mic proiect personal.'
                ]
            }
        },
        knowledgeSummary: {
            title: 'Cunostinte dobandite',
            description: ['Rest API', 'Requests/Response', 'Querystrings', 'Http(s)', 'Filesystem', 'Querystrings', 'Environment Variables', 'IPC']
        }
    },
    Databases: {
        img_0: 'db.jpg',
        skill: {
            postgres: {
                title: 'PostgreSQL',
                description: [
                    'Pricipala baza de date folosita in proiectele personale.'
                ]
            },
            mysql: {
                title: 'MySQL',
    ...
    Javascript: {
        ...
        skill: {
            angularJS: {
                title: 'AngularJS',
                description: [
                    'Used it to develop the application of one of my previous employees.'
                ]
            },
            jQuery: {
                title: 'JQuery',
                description: [
                    'Used throughout development cycles of project to maintain legacy code.'
                ]
            }
        },
        knowledgeSummary: {
    ...
    NodeJS: {
        ...
        skill: {
            ...
            sequelize: {
                title: 'Sequelize',
                description: [
                    'Used it for a small personal project.'
                ]
            }
        },
        knowledgeSummary: {
    ...
    Databases: {
        ...
        skill: {
            postgres: {
                title: 'PostgreSQL',
                description: [
                    'Main database used for personal projects.'
                ],
            },
            mysql: {
                title: 'MySQL',
