...
let AppComponent = class AppComponent {
    constructor(localeService, initService, domRootElementRef, urlListenerService) {
        ...
        this.urlListenerService.urlSubscriptionBehaviorSubject$.subscribe((currentUrlSubscription) => {
