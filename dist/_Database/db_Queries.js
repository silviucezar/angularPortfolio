...
const aboutMe_1 = require("../FE_Data_Objects/aboutMe");
const skills_1 = require("../FE_Data_Objects/skills");
const jobs_1 = require("../FE_Data_Objects/jobs");
const education_1 = require("../FE_Data_Objects/education");
const references_1 = require("../FE_Data_Objects/references");
const leaveMessage_1 = require("../FE_Data_Objects/leaveMessage");
class DBQuries {
    constructor() {
        this.createAndInsert = [
            ...
            [
                ...
                `INSERT INTO component_data VALUES
                    ('about_me_skills','${JSON.stringify(aboutMe_1.AboutMeRo)}','ro_RO','about_me_ro_RO'),
                    ('about_me_skills','${JSON.stringify(aboutMe_1.AboutMeEn)}','en_US','about_me_en_US'),
                    ('about_me_skills_jobs','${JSON.stringify(skills_1.SkillsRo)}','ro_RO','skills_ro_RO'),
                    ('about_me_skills_jobs','${JSON.stringify(skills_1.SkillsEn)}','en_US','skills_en_US'),
                    ('skills_jobs_education','${JSON.stringify(jobs_1.JobsRo)}','ro_RO','jobs_ro_RO'),
                    ('skills_jobs_education','${JSON.stringify(jobs_1.JobsEn)}','en_US','jobs_en_US'),
                    ('jobs_education_references','${JSON.stringify(education_1.EducationRo)}','ro_RO','education_ro_RO'),
                    ('jobs_education_references','${JSON.stringify(education_1.EducationEn)}','en_US','education_en_US'),
                    ('education_references_leave_message','${JSON.stringify(references_1.ReferencesRo)}','ro_RO','references_ro_RO'),
                    ('education_references_leave_message','${JSON.stringify(references_1.ReferencesEn)}','en_US','references_en_US'),
                    ('references_leave_message','${JSON.stringify(leaveMessage_1.LeaveMessageRo)}','ro_RO','leave_message_ro_RO'),
                    ('references_leave_message','${JSON.stringify(leaveMessage_1.LeaveMessageEn)}','en_US','leave_message_en_US')
                `
            ]
        ];
    }
...
//# sourceMappingURL=db_Queries.js.map